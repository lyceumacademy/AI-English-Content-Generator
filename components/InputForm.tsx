...
export const InputForm: React.FC<InputFormProps> = ({ onGenerate, onShowHistory, isHistoryLoading }) => {
    ...
    <div className="min-h-screen flex items-center justify-center p-4 sm:p-6 lg:p-8">
      <div className="max-w-6xl w-full bg-white rounded-3xl shadow-2xl p-8 sm:p-12 space-y-8 animate-fade-in-up">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <footer className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4 border-t border-gray-200">
             ...
             <button type="button" onClick={onShowHistory} disabled={isHistoryLoading} className="w-full sm:w-auto px-8 py-3 bg-blue-500 text-white font-semibold rounded-lg hover:bg-blue-600 focus:outline-none focus:ring-4 focus:ring-blue-300 transition-colors flex items-center justify-center gap-2">
                 {isHistoryLoading ? (
                    <>
